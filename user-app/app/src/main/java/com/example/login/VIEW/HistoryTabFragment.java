...
public class HistoryTabFragment extends Fragment implements BookingHistoryAdapter.OnBookingClickListener {
    ...
    private void filterAndDisplayBookings() {
        // Show all bookings in history tab
        if (allBookings.isEmpty()) {
            showEmptyState("Chưa có lịch sử đặt vé");
        } else {
